...
\renewcommand{\spacedlowsmallcaps}[1]{ \textls[80]{\textsc{#1}} } 
\renewcommand{\spacedallcaps}[1]{ \textls[160]{\MakeUppercase{#1}} }
...
% \NewEntry{address}{Vicolo Dallapiccola, I-38122, Trento} % Home address

\NewEntry{email}{\href{mailto:mat.facchini@gmail.com}{matteo.facchini@distrettoalpiorientali.it}} % Email address
...
\NewEntry{telefono}{(C) +39 340 230 4434 $\cdotp$\ \ (L) +39 338 490 1771} % Phone number(s)

% \NewEntry{}{(U) +39 0461 236000} % Phone number(s)
...
\NewEntry{Mar 2026}{Tribunale Ordinario - Trento}

\Description{\MarginText{Iscrizione Albo CTU}Iscrizione all'Albo dei Consulenti Tecnici di Ufficio.}
...
\NewEntry{Lug 2026-in corso}{\textsc{Tribunale Ordinario} -- Trento, Italia}

\Description{\MarginText{CTU}Redazione di perizie tecniche e risposte a quesiti complessi posti dal Giudice.}

\NewEntry{Apr 2023-in corso}{\textsc{Autorità di Bacino Distrettuale delle Alpi Orientali} -- Trento, Italia}

\Description{\MarginText{Funzionario}Modellazione di fenomeni di alluvione torrentizia per la mappatura del pericolo in aree soggette a rischio idrogeologico.}

\Description{Supporto al Dirigente nell'organizzazione e nel coordinamento delle attività modellistiche di Distretto per l'aggiornamento del Piano di Gestione del Rischio di Alluvioni in ambito montano, relative a fenomeni di alluvione torrentizia.}

\Description{Supporto al Dirigente nell'organizzazione delle attività legate alla valutazione degli interventi di mitigazione del rischio idrogeologico proposti sul portale ReNDiS dalle Amministrazioni appartenenti al Distretto. Valutazione degli interventi ai sensi del DPCM 27-09-2021.}

\Description{Supporto al Dirigente nella gestione dei quesiti relativi all'applicazione delle Norme Tecniche di Attuazione del Piano di Gestione del Rischio di Alluvioni.}

\Description{Attività istruttoria legata a svariati contenziosi relativi al PGRA avversi all'Autorità di bacino, in collaborazione con l'Ufficio Staff del Segretario Generale.}
...
\Description{Assistente al Direttore per l'Esecuzione del Contratto per l'appalto relativo al servizio di "Creazione di un sistema di monitoraggio mediante installazione e completamento di una rete di telerilevamento delle variabili idrologiche e idrauliche nonché di una piattaforma informatica dedicata che consenta di immagazzinare ed elaborare i dati provenienti dalla rete e anche dai cittadini, integrandoli con i modelli idraulici; sviluppo di sistemi di interfaccia e implementazione di campagne di comunicazione nel bacino dell'Adige." (CIG B14B5CAE5).}

\Description{Supporto al responsabile scientifico per la "Convenzione di ricerca per la stima, il calcolo e la modellazione del trasporto solido al di fuori del campo di applicazione delle più note formule sperimentali" con le Università di Bolzano, Trento e Padova.}
...
\NewEntry{Giu 2023}{\textsc{Ordine dei Geologi e Ordine degli Ingegneri della Regione Autonoma Friuli-Venezia Giulia} -- Pordenone (PN), Italia}

\Description{\MarginText{Formatore}Attività formativa riguardante la modellazione morfodinamica di corsi d'acqua con l'utilizzo di BASEMENT.}

%------------------------------------------------

\NewEntry{Mar 2022-Mar 2023}{\textsc{Autorità di Bacino Distrettuale delle Alpi Orientali} -- Trento, Italia}

\Description{\MarginText{Funzionario}Modellazione di fenomeni di alluvione torrentizia e colata detritica per la mappatura del pericolo in aree soggette a rischio idrogeologico.}

\Description{Partecipazione al gruppo di lavoro tecnico per l'applicazione delle Norme Tecniche di Attuazione del Piano di Gestione del Rischio di Alluvioni. Creazione di un applicativo in python per l'interpretazione delle NTA.}

%------------------------------------------------

\NewEntry{Feb 2022}{\textsc{Zollet Ingegneria srl} -- Santa Giustina (BL), Italia}

\Description{\MarginText{Formatore}Attività formativa riguardante la modellazione morfodinamica di corsi d'acqua con l'utilizzo di BASEMENT per casi reali.}

%------------------------------------------------

\NewEntry{Mag 2019-Gen 2022}{\textsc{Autorità di Bacino Distrettuale delle Alpi Orientali} -- Trento, Italia}

\Description{\MarginText{Funzionario}Modellazione di fenomeni di alluvione torrentizia e colata detritica per la mappatura del pericolo in aree soggette a rischio idrogeologico.}

\Description{Partecipazione alla stesura dell'Allegato I al Piano di Gestione del Rischio di Alluvioni, relativamente ai fenomeni da colate ed alle alluvioni torrentizie, nell'ambito dell'aggiornamento e revisione del PGRA - II ciclo di gestione.}

\Description{Organizzazione e valutazione degli interventi proposti dalle amministrazioni appartenenti al Distretto e composizione dell'Allegato III al Piano di Gestione del Rischio di Alluvioni nell'ambito dell'aggiornamento e revisione del PGRA - II ciclo di gestione.}

\Description{Partecipazione al gruppo di lavoro tecnico per l'applicazione delle Norme Tecniche di Attuazione del Piano di Gestione del Rischio di Alluvioni.}

%------------------------------------------------

\NewEntry{Feb 2019-Apr 2019}{\textsc{Studio API} -- Feltre, Italia}

\Description{\MarginText{Formatore}Attività formativa riguardante la modellazione morfodinamica di corsi d'acqua con l'utilizzo di BASEMENT per casi reali.}

%------------------------------------------------

\NewEntry{Mag 2018-Mag 2019}{\textsc{Università degli Studi di Trento} -- Trento, Italia}

\Description{\MarginText{Ricercatore}Modellazione degli effetti di rilasci di sedimenti ripetuti in fiumi alimentati da ghiacciaio.}

%------------------------------------------------

\NewEntry{Nov 2013-Gen 2018}{\textsc{ETH Zurich} -- Zurigo, Svizzera}

\Description{\MarginText{Dottorato}Monitoraggio e modellazione degli effetti dei rilasci di acqua e sedimenti da un tunnel-bypass (SBT) sul tratto di fiume a valle del tunnel.}

%------------------------------------------------

\NewEntry{Nov 2013-Ott 2017}{\textsc{ETH Zurich} -- Zurigo, Svizzera}

\Description{\MarginText{Sviluppatore}Sviluppatore del software BASEMENT (Basic Simulation Environment for Computation of Environmental Flow and Natural Hazard Simulation), usato nell'ambito dell'ingegneria fluviale e della modellazione morfodinamica.}
...
% \noindent\spacedlowsmallcaps{Esperienza come formatore}\vspace{1em}
...
\Description{\MarginText{2026}Formazione sull'utilizzo dei sistemi GNSS -- Autorità di bacino distrettuale delle Alpi Orientali -- giugno 2026}

\Description{\MarginText{2026}BASEMENT Users Meeting (2 presentazioni orali) -- ETH Zurich -- Zurigo, Svizzera -- gennaio 2026}

\Description{\MarginText{2025}International Mountain Conference -- Innsbruck, Austria -- settembre 2025.}

\Description{\MarginText{2025}HymoWat Workshop -- Lezioni apprese nell'integrazione delle traiettorie idromorfologiche per la gestione delle risorse idriche nei fiumi alpini -- Belluno, Italia -- giugno 2025.}

\Description{\MarginText{2025}Azione amministrativa e procedimento amministrativo -- Autorità di bacino distrettuale delle Alpi Orientali -- maggio 2025.}

\Description{\MarginText{2024}Formazione ed acquisizione licenza per Pilota UAS livelli A1/A3, A2 e STS -- ENAC -- gennaio 2024}

\Description{\MarginText{2023}World Landslide Forum 2023 -- Firenze, Italia -- novembre 2023.}

\Description{\MarginText{}FAD - Statistica di base (2 ore - 2 CFP) - Formazione per Ingegneri -- online -- novembre 2023.}
...
\Description{\MarginText{}GIS Open Source Avanzato (QGIS) -- Trento, Italia -- marzo 2023.}
...
\Description{\MarginText{DFRM}Buona conoscenza: modellazione di fenomeni granulari bifase (sviluppato presso TESAF - Università degli studi di Padova).}

\Description{\MarginText{Cartografia numerica e GIS}Ottima conoscenza: QGIS, Grass, Python e R. Applicazioni nell'ambito della valutazione dell'evoluzione topografica di fiumi, ovvero valutazione delle modifiche dei modelli digitali di elevazione (DEM). Analisi raster con QGIS, Grass, R e Python, integrazione di Python in QGIS, sviluppo ed utilizzo di plugins, creazione, gestione e conversione di file raster e shape.}

\Description{\MarginText{APR}abilitazione al volo con APR: patenti A1/A3, A2 e STS-specific. Utilizzo di droni per foto, video e fotogrammetria.}
...
\Description{\MarginText{MarkDown}Ottima conoscenza: scrittura di testi e report.}
...
\date{Trento, 21 luglio 2026}%\today}
