...
%	\NewEntry{phone}{(H) +39 0461 829055\ \ $\cdotp$\ \ (M) +39 340 2304434} % Phone number(s)
...
\Description{\MarginText{PhD}Laboratory of Hydraulics, Hydrology and Glaciology (VAW)\newline 
	Description: monitoring and modeling the eco-morphological effects of a sediment bypass tunnel (SBT) on the downstream river reach.\newline
...
\vspace{0.5em}
\newline
excellent knowledge of programming and scripting languages such as Python and Matlab.
\vspace{0.5em}
\newline
good knowledge of programming and scripting languages such as C++, Fortran and R.
\vspace{0.5em}
\newline
basic knowledge of other softwares used in the engineering and mathematical fields such as Maple, HecRas, Ansys CFX e Comsol Multiphysics.}
