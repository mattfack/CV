...
\NewEntry{telefono}{(U) +39 0461 236000 $\cdotp$\ \ (C) +39 340 230 4434} % Phone number(s)
...
\NewEntry{Mag 2019-presente}{Funzionario Tecnico - Ingegnere, \textsc{Autorità di Bacino Distrettuale delle Alpi Orientali} -- Trento, Italia}
...
\NewEntry{Feb 2019-Apr 2019}{Consulente Didattico, \textsc{Studio API} -- Feltre, Italia}

\Description{\MarginText{Studio API}Attività didattica riguardo l'utilizzo di BASEMENT per casi reali.}
...
\Description{\MarginText{Programmazione e Scripting}Ottima conoscenza: Python, Matlab e GitHub. 
...
\Description{\MarginText{Altri Software}Conoscenza sufficiente: Docker, Maple, HecRas, Ansys CFX e Comsol Multiphysics.}
